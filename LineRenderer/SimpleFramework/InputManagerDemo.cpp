...
void CreateControllerTestWindow()
{
	...
	if (glfwJoystickPresent(GLFW_JOYSTICK_1) == 1)
	{
		...
		joystick1Axis0 << trunc(Joystick1AxesArrayptr[0]); Joystick1Axis0 = joystick1Axis0.str();
		joystick1Axis1 << trunc(Joystick1AxesArrayptr[1]); Joystick1Axis1 = joystick1Axis1.str();
		joystick1Axis2 << trunc(Joystick1AxesArrayptr[2]); Joystick1Axis2 = joystick1Axis2.str();
		joystick1Axis3 << trunc(Joystick1AxesArrayptr[3]); Joystick1Axis3 = joystick1Axis3.str();
		joystick1Axis4 << trunc(Joystick1AxesArrayptr[4]); Joystick1Axis4 = joystick1Axis4.str();
		joystick1Axis5 << trunc(Joystick1AxesArrayptr[5]); Joystick1Axis5 = joystick1Axis5.str();
	...
	if (glfwJoystickPresent(GLFW_JOYSTICK_2) == 1)
	{
		...
		joystick2Axis1 << trunc(Joystick2Arrayptr[1]); Joystick2Axis1 = joystick2Axis1.str();
		joystick2Axis2 << trunc(Joystick2Arrayptr[2]); Joystick2Axis2 = joystick2Axis2.str();
		joystick2Axis0 << trunc(Joystick2Arrayptr[0]); Joystick2Axis0 = joystick2Axis0.str();
		joystick2Axis3 << trunc(Joystick2Arrayptr[3]); Joystick2Axis3 = joystick2Axis3.str();
		joystick2Axis4 << trunc(Joystick2Arrayptr[4]); Joystick2Axis4 = joystick2Axis4.str();
		joystick2Axis5 << trunc(Joystick2Arrayptr[5]); Joystick2Axis5 = joystick2Axis5.str();
	}
