...
void InputManagerDemo::Update(float delta)
{
	...
	if (glfwJoystickPresent(GLFW_JOYSTICK_1) == 1)
	{
		...
		joystick1Axis0 << round(Joystick1AxesArrayptr[0] * 100) / 100; Joystick1Axis0 = joystick1Axis0.str();
		joystick1Axis1 << round(Joystick1AxesArrayptr[1] * 100) / 100; Joystick1Axis1 = joystick1Axis1.str();
		joystick1Axis2 << round(Joystick1AxesArrayptr[2] * 100) / 100; Joystick1Axis2 = joystick1Axis2.str();
		joystick1Axis3 << round(Joystick1AxesArrayptr[3] * 100) / 100; Joystick1Axis3 = joystick1Axis3.str(); 
		joystick1Axis4 << round(Joystick1AxesArrayptr[4] * 100) / 100; Joystick1Axis4 = joystick1Axis4.str(); // the objective is to limit precision to 2 decimal places but I have no idea how.
		joystick1Axis5 << round(Joystick1AxesArrayptr[5] * 100) / 100; Joystick1Axis5 = joystick1Axis5.str();
	...
	if (glfwJoystickPresent(GLFW_JOYSTICK_2) == 1)
	{
		...
		joystick2Axis1 << round(Joystick2Arrayptr[1] * 100) / 100; Joystick2Axis1 = joystick2Axis1.str();
		joystick2Axis2 << round(Joystick2Arrayptr[2] * 100) / 100; Joystick2Axis2 = joystick2Axis2.str();
		joystick2Axis0 << round(Joystick2Arrayptr[0] * 100) / 100; Joystick2Axis0 = joystick2Axis0.str();
		joystick2Axis3 << round(Joystick2Arrayptr[3] * 100) / 100; Joystick2Axis3 = joystick2Axis3.str();
		joystick2Axis4 << round(Joystick2Arrayptr[4] * 100) / 100; Joystick2Axis4 = joystick2Axis4.str();
		joystick2Axis5 << round(Joystick2Arrayptr[5] * 100) / 100; Joystick2Axis5 = joystick2Axis5.str();
	}
